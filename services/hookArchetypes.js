...
const HOOK_ARCHETYPES = {
  ...
  CONTRARIAN: {
    ...
    hookExplanation: "Challenges a widely-held belief — stops readers who already have an opinion on this topic",
  },
  CONFESSION: {
    name: 'CONFESSION',
  ...
  PATTERN_INTERRUPT: {
    ...
    hookExplanation: "Says something that contradicts what readers expect — makes them stop scrolling to resolve the cognitive dissonance",
  },
  DIRECT_ADDRESS: {
    name: 'DIRECT_ADDRESS',
  ...
  STAKES: {
    ...
    hookExplanation: "Opens with a consequence before the cause — readers feel what's at risk before they know what to do about it",
  },
  BEFORE_AFTER: {
    name: 'BEFORE_AFTER',
