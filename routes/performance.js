...
// GET /api/posts/:id
// Fetches a single post by ID — used by post.html and generate.html.
// Must be in THIS router (mounted at /api/posts) so the route is explicit;
// stats.js (mounted at /api) would require falling through the performance
// router with no guarantee of reaching it.
router.get('/:id(\\d+)', async (req, res) => {
  ...
  try {
    ...
    console.error('[performance] GET /api/posts/:id error:', err);
