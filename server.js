...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc:         ["'self'", "data:", "blob:", "*.licdn.com", "media.licdn.com", "*.googleusercontent.com", "*.amazonaws.com", "images.pexels.com", "api.iconify.design"],
...
app.use('/api/carousel-packs',     requireWorkspaceMember, require('./routes/carouselPacks'));
...
app.use('/admin/carousel-packs', require('./routes/adminCarouselPacks'));
